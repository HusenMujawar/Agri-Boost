...
<body>
		...
		<div class="sidenav" style="overflow-y:scroll, width:5%;">
	...
	<div class="abc" style="padding-right:350px, width:60%;">
	<table align="center" id="table1" style="margin-right:50px;,margin-left:500px;">
		<tr>
			<th>Emp ID</th>
			<th>First Name</th>
			<th>Last Name</th>
