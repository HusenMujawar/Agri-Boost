...
<body>
	...
	<div class="sidenav" style="overflow-y:scroll">
			...
			<button class="dropdown-btn">Fertilizers
			<i class="down"></i>
			</button>
			<div class="dropdown-container">
				<a href="fertilizer-add.php">Add New Fertilizers</a>
				<a href="fertilizer-view.php">Manage Fertilizers</a>
			</div>
				...
				<div class="column">
					...
					<p>
						...
						<select id="cat" name="cat">
								...
								<option>Insesticide</option>
								<option>Herbicide</option>
								<option>Solid NPK</option>
								<option>Liquid NPK</option>
						</select>
					</p>
	...
	<?php
		...
		if(mysqli_query($conn, $sql)){
			echo "<p style='font-size:8;'>Fertilizers details successfully added!</p>";
		} else{
