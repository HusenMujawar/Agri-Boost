...
<body background-image="Ferti.png">
	...
	include "config.php";
		...
		echo "<tr>";
			...
			echo "<td align=center>";
				...
				echo "<a class='button1 edit-btn' href=fertilizer-update.php?id=".$row['med_id'].">Edit</a>";
			
				echo "<a class='button1 del-btn' href=fertilizer-delete.php?id=".$row['med_id'].">Delete</a>";
