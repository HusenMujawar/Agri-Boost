...
<body>
		...
		<div class="sidenav" style="overflow-y:scroll">
			...
			<p style="margin-top:-20px;color:white;line-height:1;font-size:12px;text-align:center">Husen Mujawar</p>
	...
	<table align="center" id="table1" style="margin-right:100px;">
		<tr>
			<th>Purchase ID</th>
			<th>Supplier ID</th>
			<th>Fertilizer ID</th>
