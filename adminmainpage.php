...
<body>
	...
	<a href="fertilizer-view.php" title="View Fertilizer">
	<img src="inventory.png" style="padding:8px;margin-left:100px;margin-top:40px;width:200px;height:200px;border:2px solid black;" alt="Fertilizer">
	</a>
